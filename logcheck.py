...
# Adding the following print statements to log the input request and output response
@app.before_request
def log_request_info():
    print('Request received:', request.method, request.url, request.json)

@app.after_request
def log_response_info(response):
    print('Response sent:', response.status_code, response.get_data())
    return response
